    ...
    public class Strategy : MarshalByRefObject, IStrategy
    {
      ...
      public void Heart(ref Mission mission, int teamId, ref Decision[] decision)
        ...
        public static void hillCharacter(ref Mission mission, int teamId, ref Decision[] decisions)
         {
            ...
            #endregion
            #region 一堆鱼使用PoseToPose函数游到指定位置
            if (hillflag[2] == 0) Helpers.PoseToPose(ref decisions[1], fish2, hill21, HD21, 6f, 200f, msPerCycle, ref timeForPoseToPose[2]);
            if (hillflag[3] == 0) Helpers.PoseToPose(ref decisions[2], fish3, hill3, HD3, 6f, 200f, msPerCycle, ref timeForPoseToPose[3]);
            if (hillflag[4] == 0) Helpers.PoseToPose(ref decisions[3], fish4, hill4, HD4, 6f, 200f, msPerCycle, ref timeForPoseToPose[4]);
            if (hillflag[5] == 0) Helpers.PoseToPose(ref decisions[4], fish5, hill5, HD5, 6f, 200f, msPerCycle, ref timeForPoseToPose[5]);
            if (hillflag[6] == 0) Helpers.PoseToPose(ref decisions[5], fish6, hill6, HD6, 6f, 200f, msPerCycle, ref timeForPoseToPose[6]);
            ...
            if (hillflag[10] == 0) Helpers.PoseToPose(ref decisions[9], fish10, hill10, HD10, 6f, 200f, msPerCycle, ref timeForPoseToPose[10]);
            #endregion;
            #region 判断是否到达目标点
            ...
            if (hillflag[0] == 1) Helpers.PoseToPose(ref decisions[1], fish2, hill22, HD22, 6f, 200f, msPerCycle, ref timeForPoseToPose[2]);
            ...
            #endregion
            #region 山字第三阶段
            if (hillflag[1] == 1) Helpers.PoseToPose(ref decisions[1], fish2, hill23, HD23, 6f, 200f, msPerCycle, ref timeForPoseToPose[2]);
        ...
        public static void numberOne(ref Mission mission, int teamId, ref Decision[] decisions)
        {
            ...
            #endregion
            #region 一堆鱼使用PoseToPose函数游到指定位置
            if (oneflag[2] == 0) Helpers.PoseToPose(ref decisions[1], fish2, one2, OD2, 6f, 200f, msPerCycle, ref timeForPoseToPose[2]);
            if (oneflag[3] == 0) Helpers.PoseToPose(ref decisions[2], fish3, one3, OD3, 6f, 200f, msPerCycle, ref timeForPoseToPose[3]);
            if (oneflag[4] == 0) Helpers.PoseToPose(ref decisions[3], fish4, one4, OD4, 6f, 200f, msPerCycle, ref timeForPoseToPose[4]);
            if (oneflag[5] == 0) Helpers.PoseToPose(ref decisions[4], fish5, one5, OD5, 6f, 200f, msPerCycle, ref timeForPoseToPose[5]);
            if (oneflag[6] == 0) Helpers.PoseToPose(ref decisions[5], fish6, one6, OD6, 6f, 200f, msPerCycle, ref timeForPoseToPose[6]);
            ...
            if (oneflag[10] == 0) Helpers.PoseToPose(ref decisions[9], fish10, one10, OD10, 6f, 200f, msPerCycle, ref timeForPoseToPose[10]);
            #endregion;
            #region 判断是否到达目标点
        ...
        public static void movingCircle(ref Mission mission, int teamId, ref Decision[] decisions)
        {
            ...
            float CD2 = -2.3562f;
            if (circleflag[1] == 0 && completeCircle == 0)  Helpers.PoseToPose(ref decisions[1], fish2, circle2, CD2, 6f, 200f, msPerCycle, ref timeForPoseToPose[2]);
            ...
            {
                #region 一堆鱼使用PoseToPose函数游到指定位置
                if (circleflag[3] == 0) Helpers.PoseToPose(ref decisions[2], fish3, circle3, CD3, 6f, 200f, msPerCycle, ref timeForPoseToPose[3]);
                if (circleflag[4] == 0) Helpers.PoseToPose(ref decisions[3], fish4, circle4, CD4, 6f, 200f, msPerCycle, ref timeForPoseToPose[4]);
                if (circleflag[5] == 0) Helpers.PoseToPose(ref decisions[4], fish5, circle5, CD5, 6f, 200f, msPerCycle, ref timeForPoseToPose[5]);
                if (circleflag[6] == 0) Helpers.PoseToPose(ref decisions[5], fish6, circle6, CD6, 6f, 200f, msPerCycle, ref timeForPoseToPose[6]);
                if (circleflag[7] == 0) Helpers.PoseToPose(ref decisions[6], fish7, circle7, CD7, 6f, 200f, msPerCycle, ref timeForPoseToPose[7]);
                if (circleflag[8] == 0) Helpers.PoseToPose(ref decisions[7], fish8, circle8, CD8, 6f, 200f, msPerCycle, ref timeForPoseToPose[8]);
                if (circleflag[9] == 0) Helpers.PoseToPose(ref decisions[8], fish9, circle9, CD9, 6f, 200f, msPerCycle, ref timeForPoseToPose[9]);
                if (circleflag[10] == 0) Helpers.PoseToPose(ref decisions[9], fish10, circle10, CD10, 6f, 200f, msPerCycle, ref timeForPoseToPose[10]);
                #endregion;
                #region 判断是否到达目标点
        ...
        public static void playWithYellowFish(ref Mission mission, int teamId, ref Decision[] decisions)
        {
            ...
            #endregion
            #region 一堆鱼使用PoseToPose函数游到指定位置
            if (playflag[3] == 0) Helpers.PoseToPose(ref decisions[2], fish3, play3, PD3, 6f, 200f, msPerCycle, ref timeForPoseToPose[3]);
            if (playflag[4] == 0) Helpers.PoseToPose(ref decisions[3], fish4, play4, PD4, 6f, 200f, msPerCycle, ref timeForPoseToPose[4]);
            if (playflag[5] == 0) Helpers.PoseToPose(ref decisions[4], fish5, play5, PD5, 6f, 200f, msPerCycle, ref timeForPoseToPose[5]);
            if (playflag[6] == 0) Helpers.PoseToPose(ref decisions[5], fish6, play6, PD6, 6f, 200f, msPerCycle, ref timeForPoseToPose[6]);
            if (playflag[7] == 0) Helpers.PoseToPose(ref decisions[6], fish7, play7, PD7, 6f, 200f, msPerCycle, ref timeForPoseToPose[7]);
            if (playflag[8] == 0) Helpers.PoseToPose(ref decisions[7], fish8, play8, PD8, 6f, 200f, msPerCycle, ref timeForPoseToPose[8]);
            if (playflag[9] == 0) Helpers.PoseToPose(ref decisions[8], fish9, play9, PD9, 6f, 200f, msPerCycle, ref timeForPoseToPose[9]);
            if (playflag[10] == 0) Helpers.PoseToPose(ref decisions[9], fish10, play10, PD10, 6f, 200f, msPerCycle, ref timeForPoseToPose[10]);
